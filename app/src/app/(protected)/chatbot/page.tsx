  ...
  (function(w, d, s, o, r) {
    ...
    return (
        <div className="p-6">
            ...
            <p className="text-gray-500 mb-8">Configure your chatbot appearance and settings.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="relative border p-4 rounded-lg bg-gray-100 shadow-inner h-[600px] flex items-center justify-center overflow-hidden">
                    <div className="absolute top-4 left-4 text-sm text-gray-500">Preview Area</div>
