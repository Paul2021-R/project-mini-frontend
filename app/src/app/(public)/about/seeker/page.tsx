        ...
        <CardContent className="p-8 md:p-12">
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-lg leading-relaxed text-muted-foreground">
              Protostar helps you maintain a living portfolio that evolves with
              your career. Our AI agents analyze your projects, code, and
              writings to highlight your unique strengths to the right
              employers. Stop applying into the void—let opportunities find you.
            </p>
