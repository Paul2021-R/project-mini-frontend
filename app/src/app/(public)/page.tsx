            ...
            <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
                <div className="container mx-auto flex max-w-[64rem] flex-col items-center gap-4 text-center">
                    ...
                    <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
                        AI-powered career management that helps you shine.
                        Organize your portfolio, prepare for interviews, and connect with opportunities.
                    </p>
            ...
            <section id="features" className="container mx-auto space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24">
                <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
                    ...
                    <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                        Protostar provides the tools you need to manage your career journey effectively.
                    </p>
                </div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                AI helps you identify and articulate your core strengths to HR managers efficiently.
                            </p>
                        </CardContent>
                    </Card>
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                Tailor your portfolio for specific roles with AI-driven insights and organization.
                            </p>
                        </CardContent>
                    </Card>
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                Enable recruiters to explore your profile through an interactive AI chatbot.
                            </p>
                        </CardContent>
                    </Card>
                </div>
