...
import { Home, MessageSquare, FileText, Settings, User, PanelLeft } from 'lucide-react';
import {
    Sidebar,
    SidebarContent,
    SidebarGroup,
    ...
    return (
        <Sidebar collapsible="icon" variant="inset">
            <SidebarHeader>
                        ...
                        <SidebarMenuButton size="lg" asChild className="md:h-8 md:p-0">
                            <Link href="/">
                                ...
                                <div className="grid flex-1 text-left text-sm leading-tight">
                                    <span className="truncate font-semibold text-lg">ProtoStar</span>
                                </div>
                            </Link>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton className="w-fit" onClick={(e) => {
